<%@ page import="com.xiaomi.entity.Good"%>
<%@ page import="com.xiaomi.service.GoodService"%>
...
<!-- start banner_y -->
		...
		<li>
			...
			<div class="pop">
			 ...
			 <%
			 	List<Good> goodsList = new GoodService().findAllGood(); 
			 ...
			 %>
				...
				<div class='item'>
				    <div class="xuangou_left fl">
						...
						<div class="xuangou_right fr item"><a href="GoodServlet?operate=detail&&goodName=${goods.goodName}" target="_blank" >选购</a></div>
						<div class="clear"></div>
					</div>
				</div>
				</c:forEach>
