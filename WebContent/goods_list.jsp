	 ...
	 <div class="danpin center">
		...
		<c:forEach items="${goodsList}" var="goods">
		    <div class="mingxing fl mb20" style="border:2px solid #fff;width:230px;cursor:pointer;" onmouseout="this.style.border='2px solid #fff'" onmousemove="this.style.border='2px solid red'">
				<div class="sub_mingxing"><a href="GoodServlet?operate=detail&&goodName=${goods.goodName }" ><img src=${goods.goodImg } alt=""></a></div>
				<div class="pinpai"><a href="GoodServlet?operate=detail&&goodName=${goods.goodName }" >${goods.goodName }</a></div>
