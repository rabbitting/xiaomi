...
<div class="danpin center">
	...
	<div class="main center">
	    ...
	    <div class="mingxing fl mb20" style="border:2px solid #fff;width:230px;cursor:pointer;" onmouseout="this.style.border='2px solid #fff'" onmousemove="this.style.border='2px solid red'">
			<div class="sub_mingxing"><a href="GoodServlet?operate=detail&&goodName=${search.goodName}" ><img src="${search.goodImg}" alt=""></a></div>
			<div class="pinpai"><a href="GoodServlet?operate=detail&&goodName=${search.goodName}" >${search.goodName}</a></div>
			<div class="youhui">${search.goodDesc}</div>
			<div class="jiage">${search.goodPrice}元</div>
		</div>
    	</c:forEach>
