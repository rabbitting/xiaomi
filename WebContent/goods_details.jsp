<%@ page language="java" import="java.util.*,com.xiaomi.entity.Good" pageEncoding="UTF-8"%>
  ...
  <input type="hidden" name="good_name" value="<%=goods.get(0).getGoodName() %>"/>
	...
	<div class="jieshao mt20 w">
		...
		<div class="right fr">
			  ...
			  <div class="jianjie mr40 ml20 mt10"><%=goods.get(0).getGoodName() %></div>
			  <div class="jiage ml20 mt10"><%=goods.get(0).getGoodPrice() %>元</div>
			  <div class="ft20 ml20 mt20">选择版本</div>	
			  <% int count = 1; %>
			  <div class='banbens'>
	    <c:forEach items="${goodtList}" var="goods" varStatus="status">
